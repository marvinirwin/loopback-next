...
describe('coerce param from string to integer - optional', function() {
  ...
  describe('integers larger than MAX_SAFE_INTEGER should trigger ERROR_BAD_REQUEST', () => {
    test(
      INTEGER_PARAM,
  ...
  describe('integer-like string values should trigger ERROR_BAD_REQUEST', () => {
    test(
      INTEGER_PARAM,
      '1.2',
  ...
  describe('all other non-integer values should trigger ERROR_BAD_REQUEST', () => {
